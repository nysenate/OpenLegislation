...
//        ArrayList<TextDiff> changes = BillTextUtils.toChanges(bill);
...
//        TextDiff a = new TextDiff(0, "plain", "<B><U>plain</U></B>");
...
//        ArrayList<TextDiff> changes = BillTextUtils.toChanges("<B><U>test</S></B>");
...
//            ArrayList<TextDiff> changes = BillTextUtils.toChanges(raw);
