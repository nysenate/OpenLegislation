...
import gov.nysenate.openleg.legislation.member.dao.MemberDataType;
...
public class MemberProcessorIT extends BaseTests {
    ...
    public void testMember(){
        ...
        int p_id = sqlMemberDao.handlePersonChange(MemberDataType.CREATE, person);
        ...
        int m_id = sqlMemberDao.handleMemberChange(MemberDataType.CREATE, member);
        ...
        int s_id = sqlMemberDao.handleSessionChange(MemberDataType.CREATE, sessionMember);
        ...
        sqlMemberDao.handlePersonChange(MemberDataType.UPDATE, updatedPerson);


        //Member Record Update
        Member updatedMember = new Member(updatedPerson,m_id, Chamber.ASSEMBLY, true);
        sqlMemberDao.handleMemberChange(MemberDataType.UPDATE, updatedMember);
        ...
        sqlMemberDao.handleSessionChange(MemberDataType.UPDATE, updateSessionMember);
        ...
        sqlMemberDao.handleSessionChange(MemberDataType.DELETE, updateSessionMember);
        try{
        ...
        sqlMemberDao.handleMemberChange(MemberDataType.DELETE, updatedMember);
        try{
            FullMember z = sqlMemberDao.getMemberById(m_id);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
        sqlMemberDao.handlePersonChange(MemberDataType.DELETE, updatedPerson);
