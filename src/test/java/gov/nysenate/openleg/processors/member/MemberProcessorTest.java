package gov.nysenate.openleg.processors.member;
...
public class MemberProcessorTest extends BaseTests
{
    private static final Logger logger = LoggerFactory.getLogger(MemberProcessorTest.class);
