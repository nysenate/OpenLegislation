<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.Date,java.text.SimpleDateFormat, java.util.ArrayList,gov.nysenate.openleg.model.Report,gov.nysenate.openleg.model.ReportObservation, gov.nysenate.openleg.model.ReportError, gov.nysenate.openleg.util.JSPHelper" %>
