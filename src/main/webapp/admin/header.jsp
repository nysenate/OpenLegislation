<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.Date, java.util.ArrayList,gov.nysenate.openleg.model.admin.report.Report,gov.nysenate.openleg.model.admin.report.ReportObservation,gov.nysenate.openleg.util.JSPHelper" %>
<!DOCTYPE html>
<html>
<head>
