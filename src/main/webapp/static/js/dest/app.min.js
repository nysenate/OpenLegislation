...
return null}function getSenSiteBillUrl(key){var billType="bills";return/^[SA]/i.test(key.printNo)||(billType="resolutions"),senSitePath+"/legislation/"+billType+"/"+key.session.year+"/"+key.printNo}function getSenSiteCalendarUrl(key){
