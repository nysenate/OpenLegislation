...
$scope.fetchIndices=function(){$scope.indexResp=IndexAPI.get({},function(){$scope.indexResp.success===!0&&($scope.indices=$scope.indexResp.result.items,$scope.indices.unshift("ALL"))},function(resp){$scope.showErrorMessage(resp)})},
