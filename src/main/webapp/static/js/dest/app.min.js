...
function setAllProperties(obj,value){for(var prop in obj)obj.hasOwnProperty(prop)&&(obj[prop]=value)}function openSummaryCtrl($scope,$filter,openSummaryApi){function getSummaries(){$scope.loadingSummaries=!0,openSummaryApi.get({},function(response){$scope.summaries=response.result.summaryMap,$scope.loadingSummaries=!1},function(errorResponse){$scope.loadingSummaries=!1,$scope.summaryRequestError=!0})}$scope.summaries={},$scope.init=function(){$scope.setHeaderText("Summary of Open Mismatches"),getSummaries()}}var openApp=angular.module("open",
// External modules
