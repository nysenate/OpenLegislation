...
$scope.showDetailedDiff=function(mismatchRow){mismatchRow.diffLoading=!0,setTimeout(function(){$mdDialog.show({templateUrl:"mismatchDetailWindow",controller:"detailDialogCtrl",locals:{mismatchRow:mismatchRow,source:$scope.datasource.selected.value,contentType:selectedContentType()}}),mismatchRow.diffLoading=!1},10)},/**
