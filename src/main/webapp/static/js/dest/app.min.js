...
var ASC=document.createElement("i");ASC.className="icon-arrow-long-up";var DESC=document.createElement("i");DESC.className="icon-arrow-long-down","ASC"==$scope.sort?event.toElement.appendChild(ASC):event.toElement.appendChild(DESC)}function formatSelectedMismatchType(mismatchType){return void 0==mismatchType||""==mismatchType.split("(")[0].trim()?void 0:$scope.inverseMismatchTypeMap[mismatchType.split("(")[0].trim()]}function resetPagination(){$scope.pagination.reset(),$scope.pagination.setTotalItems(0),$scope.pagination.itemsPerPage=10}
