...
isOpenlegRef()?($scope.referenceData=texts[1],$scope.observedData=texts[0]):($scope.referenceData=texts[0],$scope.observedData=texts[1])},init()}function ReportCtrl($scope,$route,$location,$routeParams,$mdDialog,$mdDateLocale,$timeout,paginationModel,spotcheckMismatchApi,mismatchSummaryApi,mismatchIgnoreApi,spotcheckMismatchTrackingAPI,spotcheckMismatchDeleteAllAPI){function updateOrderIcon(event){$("i.icon-arrow-long-down").remove(),// remove all down arrows
