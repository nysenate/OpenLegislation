...
function contentTypefilter(){var contentTypeMap={LBDC_AGENDA_ALERT:"Agenda",LBDC_DAYBREAK:"Bill",LBDC_CALENDAR_ALERT:"Floor Cal",LBDC_SCRAPED_BILL:"Bill",SENATE_SITE_BILLS:"Bill",SENATE_SITE_CALENDAR:"Calendar"};return function(reportType){return contentTypeMap.hasOwnProperty(reportType)?contentTypeMap[reportType]:"Content"}}function mismatchTypeFilter(){var mismatchTypeMap=angular.copy(window.mismatchMap),missingTypes={REFERENCE_DATA_MISSING:"refLabel",OBSERVE_DATA_MISSING:"dataLabel"};return function(mismatchType,dataSource){
