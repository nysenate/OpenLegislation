              ...
              <md-card class="content-card">
                <div class="subheader" layout="row" layout-sm="column" layout-align="space-between center">
                  ...
                  <div flex style="text-align: right;">
                    <dir-pagination-controls pagination-id="law-search" boundary-links="true"></dir-pagination-controls>
                  </div>
                </div>
                <md-content>
                        ...
                        <md-item>
                          <md-item-content layout-sm="column" layout-align-sm="center start" style="cursor: pointer;">
                            <div style="width:200px;padding:16px;">
                              ...
                              <h5 class="no-margin">{{law.docType}} {{law.docLevelId}}</h5>
                            </div>
                            <div flex class="md-tile-content">
                              <h4>
                                <span class="text-medium" ng-if="!highlights.title">{{law.title | default:'No Title'}}</span>
