...
export default function AgendaUpdates() {
  ...
  const doSearch = () => {
    setLoading(true)
    getAgendaUpdatesApi(detail, from + 'T00:00:00.000', to + 'T00:00:00.000', sort.toUpperCase(), using, limit, offset)
      .then((response) => {
  ...
  return (
    <div className="p-3">
      <AgendaUpdatesForm updateValues={setSearchValues} aWeekAgo={from} todaysDate={to} />
      {loading
        ? <LoadingIndicator />
        :
        <div>
