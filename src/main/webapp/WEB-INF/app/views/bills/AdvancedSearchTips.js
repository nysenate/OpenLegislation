...
export default function AdvancedSearchTips() {
  ...
  return (
    <Accordion title="Advanced Query Search Tips">
      <div>
        <p className="text text--small m-2 mb-6">You can combine the field definitions documented below to perform targeted
          searches.
      ...
      <table className="text text--small block w-full overflow-x-auto">
        ...
        <tr>
          <td colSpan="4" className="font-medium">There are 6 vote codes: AYE, NAY, AYEWR (Aye with reservations), ABS (Absent), EXC
            (Excused), ABD (Abstained)<br />
            Only AYE is shown in the examples below but you can use any of them.</td>
        </tr>
        <tr>
          <td>Ayes Count</td>
