 ...
 * @param name Sets the attribute "for" on the label and "id" on the input equal to this value.
 * @param tabIndex The input's tab index.
 * @param isHighlighted If true, the label text background will be highlighted.
 * @returns {JSX.Element}
 * @constructor
 */
export default function InputText({ label, value, onChange, placeholder, type = "text", name, tabIndex, isHighlighted = false }) {
