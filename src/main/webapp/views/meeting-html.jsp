<%@ page language="java" import="java.util.*,java.text.*,gov.nysenate.openleg.*,gov.nysenate.openleg.model.bill.*,gov.nysenate.openleg.model.committee.*,javax.xml.bind.*" contentType="text/html" pageEncoding="utf-8"%><%
...
<% 
 ...
 <div id="formatBox">
<b>Formats:</b> <a href="<%=appPath%>/api/1.0/xml/meeting/<%=meeting.luceneOid()%>">XML</a>
</div>
 </div>
