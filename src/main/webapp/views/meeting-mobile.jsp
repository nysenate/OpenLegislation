<%@ page language="java" import="java.util.*,java.text.*,gov.nysenate.openleg.*,gov.nysenate.openleg.model.bill.*,gov.nysenate.openleg.model.committee.*,javax.xml.bind.*,gov.nysenate.openleg.util.*" contentType="text/html" pageEncoding="utf-8"%><%
