...
//                    AgendaVoteAttendance member = new AgendaVoteAttendance(memberName, rank, party, attendance);
...
//                    AgendaVoteBill item = new AgendaVoteBill(bill, billAmendment, billAction, referCommittee, withAmd.equalsIgnoreCase("Y"));
