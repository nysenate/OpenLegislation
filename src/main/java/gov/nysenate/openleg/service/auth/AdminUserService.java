...
public interface AdminUserService
{
     ...
     * @param master
     */
    void createUser(String username, String password, boolean active, boolean master) throws InvalidUsernameException;
     ...
     */
    void createUser(AdminUser user) throws InvalidUsernameException;
