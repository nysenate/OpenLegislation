...
public enum SqlCommitteeQuery implements BasicSqlQuery
{
    SELECT_COMMITTEE_CURRENT_SQL(
        ...
        "WHERE " + SqlTable.COMMITTEE + ".name=:committeeName::citext" + "\n" +
    ...
    SELECT_COMMITTEE_AT_DATE_SQL(
        ...
        "WHERE committee_name=:committeeName::citext AND chamber=CAST(:chamber AS chamber) AND session_year=:sessionYear" + "\n" +
    ...
    SELECT_PREVIOUS_COMMITTEE_VERSION(
        "SELECT * FROM ${schema}." + SqlTable.COMMITTEE_VERSION + "\n" +
        "WHERE committee_name=:committeeName::citext AND chamber=CAST(:chamber AS chamber) AND session_year=:sessionYear AND :referenceDate > created" + "\n" +
    ...
    UPDATE_COMMITTEE_MEETING_INFO(
        ...
        "WHERE committee_name=:committeeName::citext  AND chamber=CAST(:chamber AS chamber) AND session_year=:sessionYear AND created=:referenceDate"
    ),
    ...
    DELETE_COMMITTEE_MEMBERS(
        ...
        "WHERE committee_name=:committeeName::citext AND chamber=CAST(:chamber AS chamber) AND session_year=:sessionYear AND version_created=:referenceDate"
    );
