...
public class SobiFragment extends BaseSourceData {
    ...
    public SobiFragment(SourceFile parentSourceFile, SobiFragmentType type, String text, int sequenceNo){
        this(generateFragmentId(parentSourceFile, type, sequenceNo), parentSourceFile, type, text, sequenceNo);
    }
    
    public SobiFragment(String fragmentId, SourceFile parentSourceFile, SobiFragmentType type, String text,
                        int sequenceNo){
    ...
    public boolean isBlockFormat(){
        return type == SobiFragmentType.BILL;
    }
                ...
                if(headerMatcher.find()){
                    if(block == null){
                        ...
                        if(newBlock.getBillHeader().equals(block.getBillHeader())){
                            ...
                            if(newBlock.getType() == SobiLineType.SUMMARY && block.getType() != SobiLineType.LAW){
