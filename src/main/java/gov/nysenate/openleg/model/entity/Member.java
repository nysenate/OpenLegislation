...
public class Member extends Person implements Serializable
{
     ...
     * @return Member
     */
    public static Member getMakeshiftMember(String lbdcShortName, SessionYear sessionYear, Chamber chamber) throws ParseError {
        ...
        catch (IllegalStateException ex) {  // i.e. there wasn't a match
