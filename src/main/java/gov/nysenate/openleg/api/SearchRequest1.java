...
public class SearchRequest1 extends AbstractApiRequest {
    ...
    public SearchRequest1(HttpServletRequest request, HttpServletResponse response,
            String format, String type, String term, int pageNumber, int pageSize, String sort, boolean sortOrder) {
