...
public enum SqlAgendaQuery implements BasicSqlQuery
{
    ...
    SELECT_AGENDAS_BY_YEAR(
        "SELECT * FROM " + SqlTable.AGENDA + " WHERE year = :year"
    ),
    SELECT_AGENDA_BY_ID(
    ...
    SELECT_AGENDA_BY_WEEK_OF(
        ...
        "FROM " + SqlTable.AGENDA + " a\n" +
        "   JOIN " + SqlTable.AGENDA_INFO_ADDENDUM + " ai\n" +
        "   ON a.agenda_no = ai.agenda_no AND a.year = ai.year\n" +
        "WHERE ai.week_of = :weekOf"
    ),
    UPDATE_AGENDA(
        "UPDATE " + SqlTable.AGENDA + "\n" +
    ...
    SELECT_AGENDA_INFO_ADDENDA(
        "SELECT * FROM " + SqlTable.AGENDA_INFO_ADDENDUM + "\n" +
        "WHERE agenda_no = :agendaNo AND year = :year"
    ),
    ...
    UPDATE_AGENDA_INFO_ADDENDUM(
        "UPDATE " + SqlTable.AGENDA_INFO_ADDENDUM + "\n" +
    ...
    INSERT_AGENDA_INFO_ADDENDUM(
        "INSERT INTO " + SqlTable.AGENDA_INFO_ADDENDUM + "\n" +
    ...
    DELETE_AGENDA_INFO_ADDENDUM(
        "DELETE FROM " + SqlTable.AGENDA_INFO_ADDENDUM + "\n" +
        "WHERE agenda_no = :agendaNo AND year = :year AND addendum_id = :addendumId"
    ),
    ...
    SELECT_AGENDA_INFO_COMMITTEES(
        "SELECT * FROM " + SqlTable.AGENDA_INFO_COMMITTEE + "\n" +
        "WHERE agenda_no = :agendaNo AND year = :year AND addendum_id = :addendumId"
    ),
    ...
    DELETE_AGENDA_INFO_COMMITTEE(
        "DELETE " + SqlTable.AGENDA_INFO_COMMITTEE + "\n" +
        "WHERE agenda_no = :agendaNo AND year = :year AND addendum_id = :addendumId " +
        "AND committee_name = :committeeName AND committee_chamber = :committeeChamber::chamber"
    ),
    ...
    SELECT_AGENDA_INFO_COMM_ITEMS(
        "SELECT * FROM " + SqlTable.AGENDA_INFO_COMMITTEE_ITEM + "\n" +
        "WHERE info_committee_id IN (" + SELECT_AGENDA_INFO_COMMITTEE_ID.sql + ") \n" +
        "ORDER BY id"
    ),
    INSERT_AGENDA_INFO_COMM_ITEM(
        "INSERT INTO " + SqlTable.AGENDA_INFO_COMMITTEE_ITEM + "\n" +
    ...
    SELECT_AGENDA_VOTE_ADDENDA(
        "SELECT * FROM " + SqlTable.AGENDA_VOTE_ADDENDUM + "\n" +
        "WHERE agenda_no = :agendaNo AND year = :year"
    ),
    ...
    UPDATE_AGENDA_VOTE_ADDENDUM(
        "UPDATE " + SqlTable.AGENDA_VOTE_ADDENDUM + "\n" +
        "SET modified_date_time = :modifiedDateTime, published_date_time = :publishedDateTime, " +
        "    last_fragment_id = :lastFragmentId\n" +
        "WHERE agenda_no = :agendaNo AND year = :year AND addendum_id = :addendumId"
    ),
    INSERT_AGENDA_VOTE_ADDENDUM(
        "INSERT INTO " + SqlTable.AGENDA_VOTE_ADDENDUM + "\n" +
    ...
    DELETE_AGENDA_VOTE_ADDENDUM(
        "DELETE FROM " + SqlTable.AGENDA_VOTE_ADDENDUM + "\n" +
        "WHERE agenda_no = :agendaNo AND year = :year AND addendum_id = :addendumId"
    ),
    ...
    SELECT_AGENDA_VOTE_COMMITTEES(
        "SELECT * FROM " + SqlTable.AGENDA_VOTE_COMMITTEE + "\n" +
        "WHERE agenda_no = :agendaNo AND year = :year AND addendum_id = :addendumId"
    ),
    SELECT_AGENDA_VOTE_COMMITTEE_ID(
        "SELECT id FROM " + SqlTable.AGENDA_VOTE_COMMITTEE + "\n" +
        "WHERE agenda_no = :agendaNo AND year = :year AND addendum_id = :addendumId\n" +
        "      AND committee_name = :committeeName AND committee_chamber = :committeeChamber::chamber"
    ),
    INSERT_AGENDA_VOTE_COMMITTEE(
        "INSERT INTO " + SqlTable.AGENDA_VOTE_COMMITTEE + "\n" +
    ...
    DELETE_AGENDA_VOTE_COMMITTEE(
        "DELETE " + SqlTable.AGENDA_VOTE_COMMITTEE + "\n" +
    ...
    SELECT_AGENDA_VOTE_ATTENDANCE(
        "SELECT * FROM " + SqlTable.AGENDA_VOTE_COMMITTEE_ATTEND + "\n" +
        "WHERE vote_committee_id IN (" + SELECT_AGENDA_VOTE_COMMITTEE_ID.sql + ")"
    ),
    INSERT_AGENDA_VOTE_ATTENDANCE(
        "INSERT INTO " + SqlTable.AGENDA_VOTE_COMMITTEE_ATTEND + "\n" +
    ...
    SELECT_AGENDA_COMM_VOTES(
        ...
        "       vr.session_member_id, vr.session_year, vr.vote_code, vr.is_remote\n" +
        "FROM " + SqlTable.AGENDA_VOTE_COMMITTEE_VOTE + " cv\n" +
        "JOIN " + SqlTable.BILL_AMENDMENT_VOTE_INFO + " vi ON cv.vote_info_id = vi.id\n" +
        "JOIN " + SqlTable.BILL_AMENDMENT_VOTE_ROLL + " vr ON vi.id = vr.vote_id\n" +
        "WHERE cv.vote_committee_id IN (" + SELECT_AGENDA_VOTE_COMMITTEE_ID.sql + ")"
    ),
    INSERT_AGENDA_COMM_BILL_VOTES(
        "INSERT INTO " + SqlTable.AGENDA_VOTE_COMMITTEE_VOTE + "\n" +
        ...
        "       :lastFragmentId\n" +
        "FROM (" + SELECT_AGENDA_VOTE_COMMITTEE_ID.sql + ") c, " +
        "     " + SqlTable.BILL_AMENDMENT_VOTE_INFO + " vi\n" +
        ...
        "      vi.vote_type = :voteType::vote_type"
    );
