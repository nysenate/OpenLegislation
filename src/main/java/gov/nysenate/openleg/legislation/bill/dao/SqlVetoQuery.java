...
public enum SqlVetoQuery implements BasicSqlQuery {
    SELECT_VETO_MESSAGE_SQL(
        "SELECT * FROM " + SqlTable.BILL_VETO + "\n" +
    ...
    UPDATE_VETO_MESSAGE_SQL(
        "UPDATE " + SqlTable.BILL_VETO + "\n" +
        "SET bill_print_no = :printNum, bill_session_year = :sessionYear, type = CAST(:type AS veto_type), " + "\n" +
    ...
    INSERT_VETO_MESSAGE_SQL(
        "INSERT INTO " + SqlTable.BILL_VETO + "\n" +
        ...
        "VALUES (:vetoNumber, :year, :printNum, :sessionYear, :chapter, :page, :lineStart, :lineEnd, :signer, :date, " + "\n" +
            " :memoText, CAST(:type AS veto_type), :modifiedDateTime, :publishedDateTime, :lastFragmentId)"
    ),
    DELETE_VETO_MESSAGE(
        "DELETE FROM " + SqlTable.BILL_VETO + "\n" +
        "WHERE veto_number = :vetoNumber AND year = :year"
    ),
    DELETE_BILL_VETOES(
        "DELETE FROM " + SqlTable.BILL_VETO + "\n" +
