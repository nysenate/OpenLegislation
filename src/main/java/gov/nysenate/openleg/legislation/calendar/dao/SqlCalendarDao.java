...
public class SqlCalendarDao extends SqlBaseDao implements CalendarDao {
    ...
    public Calendar getCalendar(CalendarId calendarId) throws DataAccessException {
        ...
        Calendar calendar = jdbcNamed.queryForObject(SqlCalendarQuery.SELECT_CALENDAR.getSql(),
    ...
    public CalendarActiveList getActiveList(CalendarActiveListId calendarActiveListId) throws DataAccessException {
        ...
        jdbcNamed.query(SqlCalendarQuery.SELECT_CALENDAR_ACTIVE_LIST.getSql(), params, activeListRowHandler);
        try {
    ...
    public Range<Integer> getActiveYearRange() {
        ...
        return jdbc.queryForObject(SqlCalendarQuery.SELECT_CALENDAR_YEAR_RANGE.getSql(),
    ...
    public int getCalendarCount() {
        return jdbc.queryForObject(SqlCalendarQuery.SELECT_TOTAL_COUNT.getSql(), Integer.class);
    }
    ...
    public int getCalendarCount(int year) {
        ...
        return jdbcNamed.queryForObject(SqlCalendarQuery.SELECT_CALENDARS_COUNT.getSql(), yearParam, Integer.class);
    }
    ...
    public int getActiveListCount(int year) {
        ImmutableParams yearParam = ImmutableParams.from(new MapSqlParameterSource("year", year));
        return jdbcNamed.queryForObject(SqlCalendarQuery.SELECT_CALENDAR_ACTIVE_LIST_ID_COUNT.getSql(), yearParam, Integer.class);
    }
    ...
    public int getCalendarSupplementalCount(int year) {
        ImmutableParams yearParam = ImmutableParams.from(new MapSqlParameterSource("year", year));
        return jdbcNamed.queryForObject(SqlCalendarQuery.SELECT_CALENDAR_SUP_ID_COUNT.getSql(), yearParam, Integer.class);
    }
    ...
    public List<CalendarId> getCalendarIds(int year, SortOrder calOrder, LimitOffset limitOffset) {
        ...
        ImmutableParams yearParam = ImmutableParams.from(new MapSqlParameterSource("year", year));
        return jdbcNamed.query(SqlCalendarQuery.SELECT_CALENDAR_IDS.getSql(orderBy, limitOffset),
    ...
    public List<CalendarActiveListId> getActiveListIds(int year, SortOrder sortOrder, LimitOffset limitOffset)
        ...
        ImmutableParams yearParam = ImmutableParams.from(new MapSqlParameterSource("year", year));
        return jdbcNamed.query(SqlCalendarQuery.SELECT_CALENDAR_ACTIVE_LIST_IDS.getSql(orderBy, limitOffset),
    ...
    public List<CalendarSupplementalId> getCalendarSupplementalIds(int year, SortOrder sortOrder, LimitOffset limitOffset)
        ...
        ImmutableParams yearParam = ImmutableParams.from(new MapSqlParameterSource("year", year));
        return jdbcNamed.query(SqlCalendarQuery.SELECT_CALENDAR_SUP_IDS.getSql(orderBy, limitOffset),
    ...
    public void updateCalendar(Calendar calendar, LegDataFragment fragment) throws DataAccessException {
        ...
        if (jdbcNamed.update(SqlCalendarQuery.UPDATE_CALENDAR.getSql(), calParams) == 0) {
            jdbcNamed.update(SqlCalendarQuery.INSERT_CALENDAR.getSql(), calParams);
        }
    ...
    private EnumMap<Version, CalendarSupplemental> getCalSupplementals(ImmutableParams calParams) {
        ...
        jdbcNamed.query(SqlCalendarQuery.SELECT_CALENDAR_SUPS.getSql(), calParams, calendarSupRowHandler);
    ...
    private void updateCalSupplementals(Calendar calendar, LegDataFragment fragment, ImmutableParams calParams) {
        ...
        for (Version supVersion : deleteSupVersions) {
            ...
            jdbcNamed.update(SqlCalendarQuery.DELETE_CALENDAR_SUP.getSql(), calSupParams);
        }
        ...
        for (Version supVersion : updateSupVersions) {
            ...
            jdbcNamed.update(SqlCalendarQuery.INSERT_CALENDAR_SUP.getSql(), supParams);
            ...
            for (CalendarSupplementalEntry entry : sup.getSectionEntries().values()) {
                ...
                addLastFragmentParam(fragment, params);
                jdbcNamed.update(SqlCalendarQuery.INSERT_CALENDAR_SUP_ENTRY.getSql(), ImmutableParams.from(params));
            }
        }
    }
    ...
    private TreeMap<Integer, CalendarActiveList> getActiveListMap(ImmutableParams calParams) {
        var activeListRowHandler = new CalendarRowHandlers.ActiveListRowHandler(false);
        jdbcNamed.query(SqlCalendarQuery.SELECT_CALENDAR_ACTIVE_LISTS.getSql(), calParams, activeListRowHandler);
    ...
    private void updateCalActiveLists(Calendar calendar, LegDataFragment fragment, ImmutableParams calParams) {
        ...
        for (Integer actListSeq : deleteActListSeqs) {
            ...
            jdbcNamed.update(SqlCalendarQuery.DELETE_CALENDAR_ACTIVE_LIST.getSql(), activeListParams);
        }
        ...
        for (Integer actListSeq : updateActListSeqs) {
            ...
            jdbcNamed.update(SqlCalendarQuery.INSERT_CALENDAR_ACTIVE_LIST.getSql(), actListParams);
            ...
            for (CalendarEntry entry : actList.getEntries()) {
                ...
                jdbcNamed.update(SqlCalendarQuery.INSERT_CALENDAR_ACTIVE_LIST_ENTRY.getSql(), entryParams);
            }
        }
    }
