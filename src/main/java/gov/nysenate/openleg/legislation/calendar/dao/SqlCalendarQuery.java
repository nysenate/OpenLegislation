...
public enum SqlCalendarQuery implements BasicSqlQuery
{
    ...
    SELECT_CALENDAR(
        "SELECT * FROM " + SqlTable.CALENDAR + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year"
    ),
    SELECT_CALENDAR_IDS(
        "SELECT calendar_no, calendar_year FROM " + SqlTable.CALENDAR + "\n" +
    ...
    SELECT_TOTAL_COUNT(
        "SELECT COUNT(*) FROM " + SqlTable.CALENDAR
    ),
    SELECT_CALENDAR_YEAR_RANGE(
        "SELECT min(calendar_year) AS min, max(calendar_year) AS max FROM " + SqlTable.CALENDAR
    ),
    UPDATE_CALENDAR(
        "UPDATE " + SqlTable.CALENDAR + "\n" +
        "SET modified_date_time = :modifiedDateTime, published_date_time = :publishedDateTime, " +
        "    last_fragment_id = :lastFragmentId\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year"
    ),
    INSERT_CALENDAR(
        "INSERT INTO " + SqlTable.CALENDAR + "\n" +
    ...
    SELECT_CALENDAR_SUPS_BY_YEAR(
        ...
        "FROM " + SqlTable.CALENDAR_SUPPLEMENTAL + " sup" + "\n" +
        "LEFT JOIN " + SqlTable.CALENDAR_SUPPLEMENTAL_ENTRY + " ent" + "\n" +
        "  ON sup.id = ent.calendar_sup_id" + "\n" +
        "WHERE calendar_year = :year"
    ),
    SELECT_CALENDAR_SUP_IDS(
        "SELECT calendar_no, calendar_year, sup_version FROM " + SqlTable.CALENDAR_SUPPLEMENTAL + "\n" +
        "WHERE calendar_year = :year"
    ),
    ...
    SELECT_CALENDAR_SUP_ID(
        "SELECT id FROM " + SqlTable.CALENDAR_SUPPLEMENTAL + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sup_version = :supVersion"
    ),
    INSERT_CALENDAR_SUP(
        "INSERT INTO " + SqlTable.CALENDAR_SUPPLEMENTAL + "\n" +
    ...
    DELETE_CALENDAR_SUP(
        "DELETE FROM " + SqlTable.CALENDAR_SUPPLEMENTAL + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sup_version = :supVersion"
    ),
    ...
    SELECT_CALENDAR_SUP_ENTRIES(
        "SELECT * FROM " + SqlTable.CALENDAR_SUPPLEMENTAL_ENTRY + "\n" +
    ...
    INSERT_CALENDAR_SUP_ENTRY(
        "INSERT INTO " + SqlTable.CALENDAR_SUPPLEMENTAL_ENTRY + "\n" +
        ...
        "FROM " + SqlTable.CALENDAR_SUPPLEMENTAL + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sup_version = :supVersion"
    ),
    DELETE_CALENDAR_SUP_ENTRIES(
        "DELETE FROM " + SqlTable.CALENDAR_SUPPLEMENTAL_ENTRY + "\n" +
        "WHERE calendar_sup_id IN (" + SELECT_CALENDAR_SUP_ID.sql + ")"
    ),
    ...
    SELECT_CALENDAR_ACTIVE_LISTS_BY_YEAR(
        ...
        "FROM " + SqlTable.CALENDAR_ACTIVE_LIST + " al" + "\n" +
        "LEFT JOIN " + SqlTable.CALENDAR_ACTIVE_LIST_ENTRY + " ent" + "\n" +
        "  ON al.id = ent.calendar_active_list_id" + "\n" +
        "WHERE calendar_year = :year"
    ),
    SELECT_CALENDAR_ACTIVE_LISTS_BY_YEAR_COUNT(
        "SELECT COUNT(*) FROM " + SqlTable.CALENDAR_ACTIVE_LIST + " al" + "\n" +
        "WHERE calendar_year = :year"
    ),
    SELECT_CALENDAR_ACTIVE_LIST_IDS(
        "SELECT calendar_no, calendar_year, sequence_no FROM " + SqlTable.CALENDAR_ACTIVE_LIST + "\n" +
        "WHERE calendar_year = :year"
    ),
    ...
    UPDATE_CALENDAR_ACTIVE_LIST(
        "UPDATE " + SqlTable.CALENDAR_ACTIVE_LIST + "\n" +
    ...
    DELETE_CALENDAR_ACTIVE_LIST(
        "DELETE FROM " + SqlTable.CALENDAR_ACTIVE_LIST + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sequence_no = :sequenceNo"
    ),
    ...
    DELETE_CALENDAR_ACTIVE_LIST_ENTRY(
        "DELETE FROM " + SqlTable.CALENDAR_ACTIVE_LIST_ENTRY + "\n" +
        "WHERE calendar_active_list_id IN (" + SELECT_CALENDAR_ACTIVE_LIST_ID.sql + ")"
    );
