...
public class Person implements Comparable<Person>
{
    ...
    // TODO: this constructor has way too many arguments.
    public Person(Integer personId, String fullName, String firstName, String middleName,
                  String lastName, String email, String pref, String suffix, String imgName) {
    ...
    public Person(Person other) {
        this(other.personId, other.fullName, other.firstName, other.middleName,
                other.lastName, other.email, other.prefix, other.suffix, other.imgName);
    }
