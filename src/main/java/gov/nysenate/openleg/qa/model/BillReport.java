...
public class BillReport {
		...
		public BillReport(long modified, Bill bill, String field) {
		...
		public static class ByHeat implements Comparator<BillReport> {
			public int compare(BillReport one, BillReport two) {
