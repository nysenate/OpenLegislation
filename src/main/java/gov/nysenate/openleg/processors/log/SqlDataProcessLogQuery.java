...
public enum SqlDataProcessLogQuery implements BasicSqlQuery
{
    SELECT_DATA_PROCESS_RUN(
        ...
        "FROM " + SqlTable.DATA_PROCESS_RUN + "\n" +
        "WHERE id = :processId"
    ),
    ...
    SELECT_DATA_PROCESS_RUNS_WITH_ACTIVITY(
        ...
        "AND (id IN (SELECT DISTINCT process_id FROM " + SqlTable.DATA_PROCESS_RUN_UNIT + ")\n" +
        "     OR (exceptions IS NOT NULL AND exceptions != '')" +
        ")"
    ),

    INSERT_DATA_PROCESS_RUN(
        "INSERT INTO " + SqlTable.DATA_PROCESS_RUN + "\n" +
    ...
    UPDATE_DATA_PROCESS_RUN(
        "UPDATE " + SqlTable.DATA_PROCESS_RUN + "\n" +
    ...
    SELECT_DATA_PROCESS_UNITS(
        ...
        "FROM " + SqlTable.DATA_PROCESS_RUN_UNIT + "\n" +
    ...
    SELECT_FIRST_AND_LAST_DATA_PROCESS_UNITS(
        ...
        "WHERE process_id = :processId AND start_date_time = " +
            "(SELECT MIN(start_date_time) FROM " + SqlTable.DATA_PROCESS_RUN_UNIT + " WHERE process_id = :processId)\n" +
        "OR start_date_time = " +
            "(SELECT MAX(start_date_time) FROM " + SqlTable.DATA_PROCESS_RUN_UNIT + " WHERE process_id = :processId)\n" +
        "ORDER BY start_date_time ASC"
    ),

    DELETE_PROCESS_UNITS(
        "DELETE FROM " + SqlTable.DATA_PROCESS_RUN_UNIT + "\n" +
        "WHERE process_id = :processId"
    ),
    INSERT_PROCESS_UNIT(
        "INSERT INTO " + SqlTable.DATA_PROCESS_RUN_UNIT + "\n" +
