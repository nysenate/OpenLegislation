...
public enum SqlCalendarAlertQuery implements BasicSqlQuery {
    ...
    SELECT_CALENDAR_SUPS_BY_YEAR(
        "SELECT * FROM ${schema}." + SqlTable.ALERT_SUPPLEMENTAL + " sup" + "\n" +
        "   JOIN ${schema}." + SqlTable.ALERT_SUPPLEMENTAL_ENTRY + " ent" + "\n" +
    ...
    SELECT_CALENDAR_SUP_ID(
        "SELECT id FROM ${schema}." + SqlTable.ALERT_SUPPLEMENTAL + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sup_version = :supVersion"
    ),
    INSERT_CALENDAR_SUP(
        "INSERT INTO ${schema}." + SqlTable.ALERT_SUPPLEMENTAL + "\n" +
    ...
    DELETE_CALENDAR_SUP(
        "DELETE FROM ${schema}." + SqlTable.ALERT_SUPPLEMENTAL + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sup_version = :supVersion"
    ),
    ...
    SELECT_CALENDAR_SUP_ENTRIES(
        "SELECT * FROM ${schema}." + SqlTable.ALERT_SUPPLEMENTAL_ENTRY + "\n" +
    ...
    INSERT_CALENDAR_SUP_ENTRY(
        "INSERT INTO ${schema}." + SqlTable.ALERT_SUPPLEMENTAL_ENTRY + "\n" +
        ...
        "FROM ${schema}." + SqlTable.ALERT_SUPPLEMENTAL + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sup_version = :supVersion"
    ),
    DELETE_CALENDAR_SUP_ENTRIES(
        "DELETE FROM ${schema}." + SqlTable.ALERT_SUPPLEMENTAL_ENTRY + "\n" +
        "WHERE calendar_sup_id IN (" + SELECT_CALENDAR_SUP_ID.sql + ")"
    ),
    ...
    SELECT_CALENDAR_ACTIVE_LISTS_BY_YEAR(
        "SELECT * FROM ${schema}." + SqlTable.ALERT_ACTIVE_LIST + " al" + "\n" +
        "   JOIN ${schema}." + SqlTable.ALERT_ACTIVE_LIST_ENTRY + " ent" + "\n" +
        "       ON al.id = ent.calendar_active_list_id" + "\n" +
        "WHERE calendar_year = :year"
    ),
    SELECT_CALENDAR_ACTIVE_LISTS_BY_YEAR_COUNT(
        "SELECT COUNT(*) FROM ${schema}." + SqlTable.ALERT_ACTIVE_LIST + " al" + "\n" +
        "WHERE calendar_year = :year"
    ),
    SELECT_CALENDAR_ACTIVE_LIST_IDS(
        "SELECT calendar_no, calendar_year, sequence_no FROM ${schema}." + SqlTable.ALERT_ACTIVE_LIST + "\n" +
        "WHERE calendar_year = :year"
    ),
    ...
    UPDATE_CALENDAR_ACTIVE_LIST(
        "UPDATE ${schema}." + SqlTable.ALERT_ACTIVE_LIST + "\n" +
    ...
    DELETE_CALENDAR_ACTIVE_LIST(
        "DELETE FROM ${schema}." + SqlTable.ALERT_ACTIVE_LIST + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sequence_no = :sequenceNo"
    ),
    ...
    SELECT_CALENDAR_ACTIVE_LIST_ENTRIES(
        "SELECT * FROM ${schema}." + SqlTable.ALERT_ACTIVE_LIST_ENTRY + "\n" +
        "WHERE calendar_active_list_id IN (" + SELECT_CALENDAR_ACTIVE_LIST_ID.sql + ")"
    ),
    INSERT_CALENDAR_ACTIVE_LIST_ENTRY(
        "INSERT INTO ${schema}." + SqlTable.ALERT_ACTIVE_LIST_ENTRY + "\n" +
    ...
    DELETE_CALENDAR_ACTIVE_LIST_ENTRY(
        "DELETE FROM ${schema}." + SqlTable.ALERT_ACTIVE_LIST_ENTRY + "\n" +
        "WHERE calendar_active_list_id IN (" + SELECT_CALENDAR_ACTIVE_LIST_ID.sql + ")"
    );
