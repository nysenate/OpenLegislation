...
public enum SqlCalendarAlertQuery implements BasicSqlQuery {
    ...
    SELECT_CALENDAR(
        "SELECT * FROM " + SqlTable.ALERT_CALENDAR + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year"
    ),
    SELECT_CALENDAR_IDS(
        "SELECT calendar_no, calendar_year FROM " + SqlTable.ALERT_CALENDAR + "\n" +
        "WHERE calendar_year = :year"
    ),
    UPDATE_CHECKED(
        "UPDATE " + SqlTable.ALERT_CALENDAR + "\n" +
        "Set checked = :checked" + "\n" +
        "WHERE calendar_no = :calendarNo and calendar_year = :year"
    ),
    MARK_PROD_CHECKED(
    ...
    INSERT_CALENDAR(
        "INSERT INTO " + SqlTable.ALERT_CALENDAR + "\n" +
    ...
    SELECT_CALENDAR_SUPS_BY_YEAR(
        "SELECT * FROM " + SqlTable.ALERT_SUPPLEMENTAL + " sup" + "\n" +
        "   JOIN " + SqlTable.ALERT_SUPPLEMENTAL_ENTRY + " ent" + "\n" +
    ...
    SELECT_CALENDAR_SUP_ID(
        "SELECT id FROM " + SqlTable.ALERT_SUPPLEMENTAL + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sup_version = :supVersion"
    ),
    INSERT_CALENDAR_SUP(
        "INSERT INTO " + SqlTable.ALERT_SUPPLEMENTAL + "\n" +
    ...
    DELETE_CALENDAR_SUP(
        "DELETE FROM " + SqlTable.ALERT_SUPPLEMENTAL + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sup_version = :supVersion"
    ),
    ...
    SELECT_CALENDAR_SUP_ENTRIES(
        "SELECT * FROM " + SqlTable.ALERT_SUPPLEMENTAL_ENTRY + "\n" +
    ...
    INSERT_CALENDAR_SUP_ENTRY(
        "INSERT INTO " + SqlTable.ALERT_SUPPLEMENTAL_ENTRY + "\n" +
        ...
        "FROM " + SqlTable.ALERT_SUPPLEMENTAL + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sup_version = :supVersion"
    ),
    DELETE_CALENDAR_SUP_ENTRIES(
        "DELETE FROM " + SqlTable.ALERT_SUPPLEMENTAL_ENTRY + "\n" +
        "WHERE calendar_sup_id IN (" + SELECT_CALENDAR_SUP_ID.sql + ")"
    ),
    ...
    SELECT_CALENDAR_ACTIVE_LISTS_BY_YEAR(
        "SELECT * FROM " + SqlTable.ALERT_ACTIVE_LIST + " al" + "\n" +
        "   JOIN " + SqlTable.ALERT_ACTIVE_LIST_ENTRY + " ent" + "\n" +
        "       ON al.id = ent.calendar_active_list_id" + "\n" +
        "WHERE calendar_year = :year"
    ),
    SELECT_CALENDAR_ACTIVE_LISTS_BY_YEAR_COUNT(
        "SELECT COUNT(*) FROM " + SqlTable.ALERT_ACTIVE_LIST + " al" + "\n" +
        "WHERE calendar_year = :year"
    ),
    SELECT_CALENDAR_ACTIVE_LIST_IDS(
        "SELECT calendar_no, calendar_year, sequence_no FROM " + SqlTable.ALERT_ACTIVE_LIST + "\n" +
        "WHERE calendar_year = :year"
    ),
    ...
    UPDATE_CALENDAR_ACTIVE_LIST(
        "UPDATE " + SqlTable.ALERT_ACTIVE_LIST + "\n" +
    ...
    DELETE_CALENDAR_ACTIVE_LIST(
        "DELETE FROM " + SqlTable.ALERT_ACTIVE_LIST + "\n" +
        "WHERE calendar_no = :calendarNo AND calendar_year = :year AND sequence_no = :sequenceNo"
    ),
    ...
    DELETE_CALENDAR_ACTIVE_LIST_ENTRY(
        "DELETE FROM " + SqlTable.ALERT_ACTIVE_LIST_ENTRY + "\n" +
        "WHERE calendar_active_list_id IN (" + SELECT_CALENDAR_ACTIVE_LIST_ID.sql + ")"
    );
