...
public enum SqlSpotCheckReportQuery implements BasicSqlQuery
{
    ...
    INSERT_REPORT(
        "INSERT INTO " + SqlTable.SPOTCHECK_REPORT + " (report_date_time, reference_date_time, reference_type, notes)\n" +
    ...
    INSERT_MISMATCH(
        "INSERT INTO " + SPOTCHECK_MISMATCH + "\n" +
