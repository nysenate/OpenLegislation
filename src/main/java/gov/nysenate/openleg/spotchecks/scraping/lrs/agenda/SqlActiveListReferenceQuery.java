...
public enum SqlActiveListReferenceQuery implements BasicSqlQuery {
    ...
    INSERT_ACTIVE_LIST_REFERENCE(
            "INSERT INTO " + SqlTable.ACTIVE_LIST_REFERENCE + "(sequence_no, calendar_no, calendar_year, " +
    ...
    INSERT_ACTIVE_LIST_REFERENCE_ENTRY(
            "INSERT INTO " + SqlTable.ACTIVE_LIST_REFERENCE_ENTRY + "(active_list_reference_id, " +
    ...
    SELECT_ACTIVE_LIST(
            "SELECT * FROM " + SqlTable.ACTIVE_LIST_REFERENCE + "\n" +
    ...
    SELECT_MOST_RECENT_FROM_EACH_YEAR(
            "SELECT * FROM " + SqlTable.ACTIVE_LIST_REFERENCE + " list1\n" +
                    "INNER JOIN(\n" +
                        "SELECT calendar_no, sequence_no, MAX(reference_date) maxdate\n" +
                        "FROM " + SqlTable.ACTIVE_LIST_REFERENCE + "\n" +
    ...
    SELECT_ACTIVE_LIST_REFERENCE_ENTRIES(
            "SELECT * FROM " + SqlTable.ACTIVE_LIST_REFERENCE_ENTRY + " refEntry, " +
                    SqlTable.ACTIVE_LIST_REFERENCE+" ref\n"+
    ...
    DELETE_REFERENCE_ENTRIES(
            "DELETE FROM " + SqlTable.ACTIVE_LIST_REFERENCE_ENTRY+"\n" +
                    "WHERE active_list_reference_id = :active_list_reference_id"
    ),
    UPDATE_ACTIVE_LIST(
            "UPDATE " + SqlTable.ACTIVE_LIST_REFERENCE + "\n" +
