...
.. code-block:: javascript

   {
      ...
      "activeVersion": "DEFAULT",                 // Current amendment version
      ...
      "amendments": {                              // Contains info specific to an amendment (base version is "DEFAULT")
        "items": {
          "DEFAULT": {                            // Map of Amendment versions
            "basePrintNo": "S2180",               // Bill print no/session details duplicated here
            "session": 2013,
            "printNo": "S2180",
            "version": "DEFAULT",                 // Amendment version
      ...
      "votes": {                                  // Votes will be stored here if there are any
         "items": [
          {
            "version": "DEFAULT",                 // Amendment version vote was taken on
      ...
      "actions": {                                 // The actions that have occurred on a bill
         "items": [
         {
            "billId": {
               ...
               "session": 2013,
               "printNo": "S6830",
               "version": "DEFAULT"                // Specifies which amendment version of the bill the action affects
            },
